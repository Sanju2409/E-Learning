    ...
    //                                         <Link to="/Stud_view_materials" state={{ userEmail, courseId: course.courseId, staffId: course.staffId }} className="view-button">View Materials</Link>
    //                                         <Link to="/QuizStudent" state={{ userEmail, courseId: course.courseId, staffId: course.staffId }} className="attempt-button">Attempt task now</Link>
    //                                         <Link to="/Grades" state={{ userEmail, courseId: course.courseId, staffId: course.staffId }} className="grades-button">Grades</Link>
    //                                     </div>
    //                                 </div>
    //                             </div>
    //                         ))}
...
//                                             <Link to="/Stud_view_materials" state={{ userEmail, courseId: course.courseId, staffId: course.staffId }} className="option-link">View Materials</Link>
//                                         </button>
//                                         <button className="attempt-button">
//                                             <Link to="/QuizStudent" state={{ userEmail, courseId: course.courseId, staffId: course.staffId }} className="option-link">Attempt task now</Link>
//                                         </button>
//                                         <button className="grades-button">
//                                             <Link to="/Grades" state={{ userEmail, courseId: course.courseId, staffId: course.staffId }} className="option-link">Grades</Link>
//                                         </button>
//                                     </div>
//                                 </div>
//                             </div>
