        ...
        {material.map(material => (
          <li key={material._id} className="material-content-item">
            <div className="material-card">
              <div className="material-card-title">{material.filePath}</div>
              <a href={`http://localhost:3001/material-content?filePath=${material.filePath}`} target="_blank" rel="noopener noreferrer" className="material-card-link">
                Open
              </a>
            </div>
          </li>
